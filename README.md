...
This plugin includes a powerful Artisan command that allows server administrators to clean up old Minecraft log files and crash reports directly from the terminal or via scheduled tasks (cronjobs).
